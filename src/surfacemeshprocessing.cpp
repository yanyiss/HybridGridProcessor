...
void SurfaceMeshProcessing::createActions()
{
	...
	diagonalmeshAction->setChecked(false);
	connect(diagonalmeshAction, SIGNAL(triggered()), this, SLOT(diagonalmeshShow()));
...
void SurfaceMeshProcessing::diagonalmeshShow()
{
	viewer->setDrawMode(InteractiveViewerWidget::DIAGONAL_MESH);
	viewer->setMouseMode(InteractiveViewerWidget::TRANS);
}
